...
![Default Token Contract Test ](./assets/near-cross-contract-calls-default-token-contract-test.png)
...
![Jest tests running for Calculator Contract](./assets/near-cross-contract-calls-jest-tests-running-for-calculator-contract.png)
...
![Create fresh workspace](./assets/near-cross-contract-calls-create-fresh-workspace.png)
...
![Cross contract call Jest test](./assets/near-cross-contract-calls-cross-contract-call-jest-test.png)
