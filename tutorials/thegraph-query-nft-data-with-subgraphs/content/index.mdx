...
![Subgraph Studio](./assets/thegraph-query-nft-data-with-subgraphs-subgraph-studio-1.png)
...
![OpenSea assets](./assets/thegraph-query-nft-data-with-subgraphs-open-sea-assets-2.png)
...
![OpenSea Galaxy-Eggs](./assets/thegraph-query-nft-data-with-subgraphs-open-sea-galaxy-eggs-3.png)

Click on any of the NFTs to view its display page:

![OpenSea Galaxy-Eggs #7836](./assets/thegraph-query-nft-data-with-subgraphs-open-sea-galaxy-eggs-7836-4.png)
...
![Login to Subgraph Studio](./assets/thegraph-query-nft-data-with-subgraphs-login-to-subgraph-studio-5.png)
...
![Create your first subgraph](./assets/thegraph-query-nft-data-with-subgraphs-create-your-first-subgraph-6.png)
...
![GalaxyEggs NFT subgraph](./assets/thegraph-query-nft-data-with-subgraphs-galaxy-eggs-nft-subgraph-7.png)
...
![GalaxyEggs NFT Subgraph](./assets/thegraph-query-nft-data-with-subgraphs-galaxy-eggs-nft-subgraph-8.png)
...
![GalaxyEggs NFT Subgraph Publish](./assets/thegraph-query-nft-data-with-subgraphs-galaxy-eggs-nft-subgraph-publish-9.png)
