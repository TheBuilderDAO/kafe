...
![Subgraph Studio](./assets/thegraph-query-ethereum-data-with-the-graph-subgraph-studio-1.png)
...
![Login to Subgraph Studio](./assets/thegraph-query-ethereum-data-with-the-graph-login-to-subgraph-studio-2.png)
...
![Create your first subgraph](./assets/thegraph-query-ethereum-data-with-the-graph-create-your-first-subgraph-3.png)

Next, you need to give your subgraph a name. Give the name as **vending**. Once that's done, you will see this screen:

![Subgraph dashboard](./assets/thegraph-query-ethereum-data-with-the-graph-subgraph-dashboard-4.png)
...
![Subgraph Studio Playground](./assets/thegraph-query-ethereum-data-with-the-graph-subgraph-studio-playground-5.png)
...
![Rinkeby Smart Contract](./assets/thegraph-query-ethereum-data-with-the-graph-rinkeby-smart-contract-6.png)
...
![Rinkeby Smart Contract Purchase](./assets/thegraph-query-ethereum-data-with-the-graph-rinkeby-smart-contract-purchase-7.png)
...
![Metamask](./assets/thegraph-query-ethereum-data-with-the-graph-metamask-8.png)
