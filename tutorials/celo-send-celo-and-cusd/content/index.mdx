...
<Hint type="info">
  At any point in the file you can console.log() variables to print their output
  when you run the script.
</Hint>

## Reading from Alfajores
...
<Hint type="danger">
  This is not the standard way of managing Celo accounts. In a production
  environment, the Celo Wallet will manage accounts for you. Accessing accounts
  from the Celo Wallet will be discussed in future guides.
</Hint>
