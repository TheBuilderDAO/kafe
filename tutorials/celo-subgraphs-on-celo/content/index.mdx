...
keywords: [Graphql, Solidity, NodeJS, Smart contracts, Truffle, Solidity]
date: '2022-03-22T06:03:54.763Z'
---
...
- Go to your dashboard and click on **Add Subgraph**. Fill in the required details and click on **Create subgraph**.
  ...
  ![Create subgraph](./assets/celo-subgraph-01-dashboard-create-new.png)
