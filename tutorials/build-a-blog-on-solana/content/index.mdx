...
keywords: ['kafe']
date: '2020-04-24'
description: 'Elit aliquip esse labore proident duis Lorem quis sit non occaecat.'
next:
  title: 'Part 2'
  slug: '/part_2'
---

## Part 1: This is a Test

Elit aliquip esse labore proident duis Lorem quis sit non occaecat.
...
tutorials/build-a-blog-on-solana/content/assets/template_regex.png
...
This is the end of the Kafé guide template. Remember to RegEx for `^> > >.*$` and remove those lines to have a clean template for writing!
