...
keywords: [Solana, Rust, Smart contracts, Rust]
date: '2021-11-01T21:50:52.879Z'
---

![Logo](./assets/solana-build-a-blog-dapp-using-anchor-logo-1.png)
...
<Embed
  url="https://youtu.be/w-n87Aq3f8k"
  caption="SolBlog - Solana blog platform built with Anchor"
/>
...
![](./assets/solana-build-a-blog-dapp-using-anchor-image-2.png)
...
![](./assets/solana-build-a-blog-dapp-using-anchor-image-3.png)
...
![](./assets/solana-build-a-blog-dapp-using-anchor-image-4.png)
...
![](./assets/solana-build-a-blog-dapp-using-anchor-image-5.png)
...
![](./assets/solana-build-a-blog-dapp-using-anchor-image-6.png)
...
![](./assets/solana-build-a-blog-dapp-using-anchor-image-7.png)
...
![run](./assets/solana-build-a-blog-dapp-using-anchor-run-8.png)

Open up your browser to `http://localhost:3000` and play around!

![](./assets/solana-build-a-blog-dapp-using-anchor-image-9.png)
