...
![Hardhat Initializing](./assets/polygon-create-nft-smart-contract-with-hardhat-hardhat-initializing.png)
...
![Hardhat Initialized](./assets/polygon-create-nft-smart-contract-with-hardhat-hardhat-initialized.png)
...
![Initial File Structure](./assets/polygon-create-nft-smart-contract-with-hardhat-initial-file-structure.png)
...
![Running Tests](./assets/polygon-create-nft-smart-contract-with-hardhat-running-tests.png)
...
![Creating ENV File](./assets/polygon-create-nft-smart-contract-with-hardhat-creating-env-file.png)
...
![Deploying Contract](./assets/polygon-create-nft-smart-contract-with-hardhat-deploying-contract.png)
...
![Contract Deployed and Verified](./assets/polygon-create-nft-smart-contract-with-hardhat-contract-deployed-and-verified.png)
...
![MetaMask Sign Popup](./assets/polygon-create-nft-smart-contract-with-hardhat-meta-mask-sign-popup.png)
...
![NFT in Opensea Testnet](./assets/polygon-create-nft-smart-contract-with-hardhat-nft-in-opensea-testnet.png)
