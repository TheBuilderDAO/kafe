...
![Image displaying contract_architecture](./assets/avalanche-create-an-avalanche-crowdfunding-app-image-displaying-contract-architecture-1.png)
...
![image of metamask](./assets/avalanche-create-an-avalanche-crowdfunding-app-image-of-metamask-2.png)
...
![Picture of Remix site](./assets/avalanche-create-an-avalanche-crowdfunding-app-picture-of-remix-site-3.png)
...
![gif displaying the process of creating a project](./assets/avalanche-create-an-avalanche-crowdfunding-app-gif-displaying-the-process-of-creating-a-project-4.png)

## Fund Project

![gif displaying the process of funding a project](./assets/avalanche-create-an-avalanche-crowdfunding-app-gif-displaying-the-process-of-funding-a-project-5.png)

## Claim Fund

![gif displaying the process of claiming refund](./assets/avalanche-create-an-avalanche-crowdfunding-app-gif-displaying-the-process-of-claiming-refund-6.png)

## Claim Refund

![gif displaying the process of claiming refund](./assets/avalanche-create-an-avalanche-crowdfunding-app-gif-displaying-the-process-of-claiming-refund-7.png)
...
![metamask wallet image with 0 AVAX](./assets/avalanche-create-an-avalanche-crowdfunding-app-metamask-wallet-image-with-0-avax-8.png)

- Make sure that you have selected the correct account on Metamask if you have more than one account connected to the site.

![metamask wallet with multiple account display](./assets/avalanche-create-an-avalanche-crowdfunding-app-metamask-wallet-with-multiple-account-display-9.png)
