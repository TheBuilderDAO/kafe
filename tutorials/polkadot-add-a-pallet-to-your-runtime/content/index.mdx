...
![TODO:NOT_FOUND Set a Name](./assets/polkadot-add-a-pallet-to-your-runtime-set-a-name-1.png)
...
![TODO:NOT_FOUND Read a Name](./assets/polkadot-add-a-pallet-to-your-runtime-read-a-name-2.png)
...
![TODO:NOT_FOUND Read an Empty Name](./assets/polkadot-add-a-pallet-to-your-runtime-read-an-empty-name-3.png)
...
![TODO:NOT_FOUND `BadOrigin` Error](./assets/polkadot-add-a-pallet-to-your-runtime-bad-origin-error-4.png)
...
![TODO:NOT_FOUND Nicks Pallet Error](./assets/polkadot-add-a-pallet-to-your-runtime-nicks-pallet-error-5.png)
