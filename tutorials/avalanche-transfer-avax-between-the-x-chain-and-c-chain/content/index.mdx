...
![](./assets/avalanche-transfer-avax-between-the-x-chain-and-c-chain-image-1.png)
...
![](./assets/avalanche-transfer-avax-between-the-x-chain-and-c-chain-image-2.png)
...
![](./assets/avalanche-transfer-avax-between-the-x-chain-and-c-chain-image-3.png)
...
![](./assets/avalanche-transfer-avax-between-the-x-chain-and-c-chain-image-4.png)

Enter the amount you wish to transfer from the X-Chain to the C-Chain.

## Step 5 - Confirm the Transaction

![](./assets/avalanche-transfer-avax-between-the-x-chain-and-c-chain-image-5.png)
...
![](./assets/avalanche-transfer-avax-between-the-x-chain-and-c-chain-image-6.png)
