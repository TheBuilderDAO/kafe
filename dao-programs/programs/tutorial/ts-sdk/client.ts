...
export class TutorialProgramClient {
  ...
  async getTutorialBySlug(slug: string) {
    return proposalAccountBySlug(
      this.tutorialProgram,
      this.pda.pdaTutorialBySlug,
      slug,
    );
  }

  async getTutorialById(id: number) {
    return proposalAccountById(this.tutorialProgram, id);
  }

  async getListOfVoters(slug: string) {
    return listOfVoterBySlug(
      this.tutorialProgram,
      this.pda.pdaTutorialBySlug,
      slug,
    );
  ...
  async getVote(slug: string, publicKey: PublicKey) {
    return userVoteAccountBySlug(
      this.tutorialProgram,
      this.pda.pdaTutorialBySlug,
      this.pda.pdaUserVoteAccountBySlug,
      publicKey,
      slug,
    );
  }
