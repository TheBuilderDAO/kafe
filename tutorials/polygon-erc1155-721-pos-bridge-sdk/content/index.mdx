...
![tokens balance](./assets/pos-bridge-sdk-balance-metamask.png)
...
![mumbai](./assets/erc1155-pos-mumbai.png)
...
- Choose **Goerli Testnet -> Mumbai testnet**
  ...
  - ERC-1155
    ...
    ![map image](./assets/erc1155-pos-map.png)

  - ERC-721

    ![map image](./assets/erc721-pos-map.png)
...
![mapped image](./assets/erc1155-pos-mapped.png)
...
![metamask after map](./assets/pos-bridge-sdk-metamask-mumbai.png)
...
![balances Metamask](./assets/pos-bridge-sdk-metamask-mumbai-after.png)
...
![Deposit](./assets/erc721-pos-ui-deposit.png)
...
![Transfer Done](./assets/erc721-pos-ui-done.png)
