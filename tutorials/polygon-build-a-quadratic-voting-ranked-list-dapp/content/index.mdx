...
keywords: [Solidity, Truffle, Solidity, IPFS]
date: '2022-03-22T06:04:27.323Z'
---
...
![app demo](./assets/quadratic-voting-complete.png)
...
![MetaMask config](./assets/metamask-settings-mumbai.webp)
...
![file structure](./assets/quadratic-voting-folder-structure.png)
...
![truffle compile](./assets/quadratic-voting-truffle-compile.png)
...
![truffle migrate](./assets/quadratic-voting-truffle-migrate.png)
...
![truffle test](./assets/quadratic-voting-truffle-test.png)
...
![create item](./assets/quadratic-voting-create-item.png)

When you click on the "Create Item" button you should see MetaMask prompt you to confirm the transaction.

![create item MetaMask](./assets/quadratic-voting-create-item-metamask.png)
...
![ranked items with claim button](./assets/quadratic-voting-ranked-items-claim.png)
...
![ranked items with voting controls](./assets/quadratic-voting-ranked-items-voting.png)

Interacting with the "Up"/"Down" buttons will reveal a submit section that allows you to quadratically vote on the item.

![submit vote](./assets/quadratic-voting-submit-vote.png)
...
![submit vote MetaMask](./assets/quadratic-voting-submit-vote-metamask.png)
...
![completed app](./assets/quadratic-voting-complete.png)
