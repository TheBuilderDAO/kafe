...
1. [Substrate KnowledgeBase](https://substrate.dev/docs/en/knowledgebase)
2. [Pallet DID](https://github.com/substrate-developer-hub/pallet-did)
3. [Template Pallet](https://github.com/substrate-developer-hub/substrate-pallet-template)
4. [Substrate Rust Docs](https://substrate.dev/rustdocs)
