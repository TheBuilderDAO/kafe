...
![import private key in phantom screen shot.jpg](./assets/import_private_key_in_phantom_screen_shot.jpg?raw=true)

Then choose a name and copy-paste the private key:

![linking NFTs wallet in phantom screenshot.jpg](./assets/linking_NFTs_wallet_in_phantom_screenshot.jpg?raw=true)
...
![changing the network from mainnet to devnet screenshot.jpg](./assets/changing_the_network_from_mainnet_to_devnet_screenshot.jpg?raw=true)
...
![background1.png](./assets/background1.png?raw=true)

![background2.png](./assets/background2.png?raw=true)

Circles:

![circle1.png](./assets/circle1.png?raw=true)

![circle2.png](./assets/circle2.png?raw=true)

![circle3.png](./assets/circle3.png?raw=true)

Triangles:

![triangle1.png](./assets/triangle1.png?raw=true)

![triangle2.png](./assets/triangle2.png?raw=true)

![triangle3.png](./assets/triangle3.png?raw=true)
...
**seller\_fee\_basis\_points**: This parameter specifies the share which creators want to earn from future sales of their NFTs. Each point is 0.01% so if a creator wants to earn 1% from future trades of their collection they should set it to 100 points. This parameter is also referred to as a royalty percentage.

**external\_url**: If the collection has a website or a YouTube channel or a link related, you can put it here.
...
First, you need to install dependencies for this engine. Open a terminal and make sure you’re at **hashlips\_art\_engine**  directory and run `yarn install`.
...
![initial\_state\_of\_dapp\_screenshot.jpg](./assets/initial_state_of_dapp_screenshot.jpg?raw=true)
...
![NFT minting gif.gif](./assets/minting_nft_on_dapp_gif.gif?raw=true)

YaY, we did it! Let’s check out our newly minted NFT in our wallet:

![Checking NFT in wallet gif.gif](./assets/checking_nft_in_phantom_wallet.gif?raw=true)
...
If you found any misinformation in the article or had any suggestions to improve the tutorial you can message me on Twitter: [@mahdi\_ftp](http://twitter.com/mahdi_ftp).
