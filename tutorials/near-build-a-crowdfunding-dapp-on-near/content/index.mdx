...
![project image](./assets/near-build-a-crowdfunding-dapp-on-near-project-image.png)
...
![create crowdfund](./assets/near-build-a-crowdfunding-dapp-on-near-create-crowdfund.png)

Now everything is successfully installed, and everything is ready to go, let’s look at what our file structure looks like.

## File structure

![file structure](./assets/near-build-a-crowdfunding-dapp-on-near-file-structure.png)
...
![sub account](./assets/near-build-a-crowdfunding-dapp-on-near-sub-account.png)
...
![deploy contract](./assets/near-build-a-crowdfunding-dapp-on-near-deploy-contract.png)
...
![add crowdfund](./assets/near-build-a-crowdfunding-dapp-on-near-add-crowdfund.png)
...
![addvote](./assets/near-build-a-crowdfunding-dapp-on-near-addvote.png)
...
![list crowdfunds](./assets/near-build-a-crowdfunding-dapp-on-near-list-crowdfunds.png)
...
![Login](./assets/near-build-a-crowdfunding-dapp-on-near-login.png)
