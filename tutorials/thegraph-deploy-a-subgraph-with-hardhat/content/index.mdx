...
![Subgraph Studio](./assets/thegraph-deploy-a-subgraph-with-hardhat-subgraph-studio-1.png)
...
![Login to Subgraph Studio](./assets/thegraph-deploy-a-subgraph-with-hardhat-login-to-subgraph-studio-2.png)
...
![Create your first subgraph](./assets/thegraph-deploy-a-subgraph-with-hardhat-create-your-first-subgraph-3.png)

Next, you need to give your subgraph a name. Give the name as **vending**. Once that's done, you will see this screen:

![Subgraph dashboard](./assets/thegraph-deploy-a-subgraph-with-hardhat-subgraph-dashboard-4.png)
