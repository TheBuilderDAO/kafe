...
<Hint
  style="danger" %}Carefully notice the order of balance update we are performing in the above function. We are first deducting the tokens from the users' account and in the very last step, we are updating her share balance. This is done to prevent a reentrancy attack.{% endhint>
null
</Hint>
...
![Metamask](./assets/avalanche-create-an-amm-on-avalanche-metamask.png)
...
![remix-preview](./assets/avalanche-create-an-amm-on-avalanche-remix-preview.png)
...
<Hint
  style="info" %}An Application Binary Interface (ABI) is a JSON object which stores the metadata about the methods of a contract like data type of input parameters, return data type & property of the method like payable, view, pure, etc. You can learn more about the ABI from the solidity documentation{% endhint>
null
</Hint>
...
![preview](./assets/avalanche-create-an-amm-on-avalanche-preview.png)
...
![Zero balance preview](./assets/avalanche-create-an-amm-on-avalanche-zero-balance-preview.png)

- Make sure that you have selected the correct account on Metamask if you have more than one account connected to the site.

![Multiple account preview](./assets/avalanche-create-an-amm-on-avalanche-multiple-account-preview.png)
