...
![App demo](./assets/polygon-peer-to-peer-payment-on-polygon-part-2-app-demo-1.png)
...
![Metamask Import Token](./assets/polygon-peer-to-peer-payment-on-polygon-part-2-metamask-import-token-2.png)

![Metamask Import Token form](./assets/polygon-peer-to-peer-payment-on-polygon-part-2-metamask-import-token-form-3.png)
...
![Tokens Modal](./assets/polygon-peer-to-peer-payment-on-polygon-part-2-tokens-modal-4.png)
