...
![Subgraph Studio](./assets/the-graph-deploy-a-subgraph-for-polygon-subgraph-studio-1.png)
...
![Datahub Signup](./assets/the-graph-deploy-a-subgraph-for-polygon-datahub-signup-2.png)
...
![Datahub Polygon API Key](./assets/the-graph-deploy-a-subgraph-for-polygon-datahub-polygon-api-key-3.png)
...
![Login to Subgraph Studio](./assets/the-graph-deploy-a-subgraph-for-polygon-login-to-subgraph-studio-4.png)
...
![Create your first subgraph](./assets/the-graph-deploy-a-subgraph-for-polygon-create-your-first-subgraph-5.png)

Next, you need to give your subgraph a name. Give the name as **FunNFT**. Once that's done, you will see this screen:

![Subgraph dashboard](./assets/the-graph-deploy-a-subgraph-for-polygon-subgraph-dashboard-6.png)
