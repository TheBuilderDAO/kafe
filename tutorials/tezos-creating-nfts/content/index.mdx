...
keywords: [Tezos, JS/TS, NodeJS, CLI]
date: '2021-07-22T09:41:42.398Z'
---
...
The commands will be explained in more detail below. You can always run `tznft --help` to list all available commands.
...
1.  You can inspect the file on the web by opening a URL `https://ipfs.io/ipfs/<ipfs_cid>`. For our example, the URL would be <https://ipfs.io/ipfs/QmRyTc9KbD7ZSkmEf4e7fk6A44RPciW5pM4iyqRGrhbyvj>
