...
<Hint
  type="info" %}Note down that the default unit is set to DOT which multiplies the input by a factor of 10^4. So if we wish to pass a value say 10 (which corresponds to 1% trading fee, 10/1000 fraction, in our contract) then we need to write 0.0001 DOT.{% endhint>
null
</Hint>
