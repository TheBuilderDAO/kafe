...
![import private key in phantom screen shot.jpg](./assets/import_private_key_in_phantom_screen_shot.jpg)

Then choose a name and copy-paste the private key:

![linking NFTs wallet in phantom screenshot.jpg](./assets/linking_nfts_wallet_in_phantom_screenshot.jpg)
...
![changing the network from mainnet to devnet screenshot.jpg](./assets/changing_the_network_from_mainnet_to_devnet_screenshot.jpg)
...
![background1.png](./assets/background1.png)

![background2.png](./assets/background2.png)

Circles:

![circle1.png](./assets/circle1.png)

![circle2.png](./assets/circle2.png)

![circle3.png](./assets/circle3.png)

Triangles:

![triangle1.png](./assets/triangle1.png)

![triangle2.png](./assets/triangle2.png)

![triangle3.png](./assets/triangle3.png)
...
![initial_state_of_dapp_screenshot.jpg](./assets/initial_state_of_dapp_screenshot.jpg)
...
![NFT minting gif.gif](./assets/minting_nft_on_dapp_gif.gif)

YaY, we did it! Let’s check out our newly minted NFT in our wallet:

![Checking NFT in wallet gif.gif](./assets/checking_nft_in_phantom_wallet.gif)
