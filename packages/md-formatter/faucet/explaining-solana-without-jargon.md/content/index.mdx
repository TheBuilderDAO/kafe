...
In a network with DATA\_PLANE\_FANOUT = 200, a Leader at the top can reach up to 40,000 (200\*200) Validators in 2 jumps in the tree. Which takes 200ms assuming each link inside the network resolves in 100ms on average.
...
in case you found any misinformation in the article or had any suggestions to improve the article please comment on it or you can find me on Twitter: [@mahdi\_ftp](http://twitter.com/mahdi_ftp).
