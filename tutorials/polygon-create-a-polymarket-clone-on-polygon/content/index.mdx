...
![Demo GIF](./assets/polygon-create-a-polymarket-clone-on-polygon-demo-gif.png)
...
![Pages folder structure](./assets/polygon-create-a-polymarket-clone-on-polygon-pages-folder-structure.png)

`index.tsx` contains the main page for users where all the markets are listed.

![Index page](./assets/polygon-create-a-polymarket-clone-on-polygon-index-page.png)

`portfolio.tsx` contains all the market bets placed by the logged-in user.

![Portfolio view](./assets/polygon-create-a-polymarket-clone-on-polygon-portfolio-view.png)

`admin/index.tsx` used by admin to create new markets.

![Admin form view](./assets/polygon-create-a-polymarket-clone-on-polygon-admin-form-view.png)
...
![Admin market list](./assets/polygon-create-a-polymarket-clone-on-polygon-admin-market-list.png)
...
![Market details](./assets/polygon-create-a-polymarket-clone-on-polygon-market-details.png)
...
![Navbar](./assets/polygon-create-a-polymarket-clone-on-polygon-navbar.png)
...
![Polymarket Card](./assets/polygon-create-a-polymarket-clone-on-polygon-polymarket-card.png)
...
![Admin index demo](./assets/polygon-create-a-polymarket-clone-on-polygon-admin-index-demo.png)
...
![Admin market resolve](./assets/polygon-create-a-polymarket-clone-on-polygon-admin-market-resolve.png)
