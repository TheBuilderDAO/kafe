...
![mumbai](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-mumbai.png)
...
- Choose **Gorli Testnet -> Mumbai testnet**
  ...
  ![map image](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-map-image.png)
...
![mapped image](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-mapped-image.png)
...
![metamask after map](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-metamask-after-map.png)
...
![MLB Metamask](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-mlb-metamask.png)
...
2.  Make sure Ethereum Mainnet is selected in Metamask
    ...
    ![Metamask Ethereum](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-metamask-ethereum.png)
...
4.  You will be asked to sign a **Signature Request** to make sure you have access to the wallet. It costs no fees
    ...
    ![pos web ui login](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-pos-web-ui-login.png)

5.  I chose `DAI` token from Ethereum

    ![DAI](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-dai.png)
...
7.  Then review the transaction details, like gas fees and the smart contract you are sending tokens to - before clicking on **Confirm**
    ...
    ![transfer](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-transfer.png)
