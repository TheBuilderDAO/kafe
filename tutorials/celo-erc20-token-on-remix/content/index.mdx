...
![accessibility text](./assets/celo-erc20-token-on-remix-accessibility-text-1.png)

c. Pay the `transaction fee` and sign the transaction using celo wallet.

![accessibility text](./assets/celo-erc20-token-on-remix-accessibility-text-2.png)
...
![accessibility text](./assets/celo-erc20-token-on-remix-accessibility-text-3.png)

c. Click on `Transact`

![accessibility text](./assets/celo-erc20-token-on-remix-accessibility-text-4.png)
...
![accessibility text](./assets/celo-erc20-token-on-remix-accessibility-text-5.png)

- Enter the contract address in **Token Contract Address** and click `Next`.

![accessibility text](./assets/celo-erc20-token-on-remix-accessibility-text-6.png)

- Click on `Add token`

Now we are able to see our token balance!

![accessibility text](./assets/celo-erc20-token-on-remix-accessibility-text-7.png)
