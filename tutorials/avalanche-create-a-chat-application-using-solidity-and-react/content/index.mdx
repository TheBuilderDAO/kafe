...
![User registration and adding a new friend](./assets/avalanche-create-a-chat-application-using-solidity-and-react-user-registration-and-adding-a-new-friend-3.png)
