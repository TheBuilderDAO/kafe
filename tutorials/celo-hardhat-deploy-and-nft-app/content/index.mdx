...
![Captura de Tela (39)](./assets/celo-hardhat-deploy-and-nft-app-captura-de-tela-39.png)
...
![Captura de Tela (49)](./assets/celo-hardhat-deploy-and-nft-app-captura-de-tela-49.png) ![Captura de Tela (50)](./assets/celo-hardhat-deploy-and-nft-app-captura-de-tela-50.png) After you connect to a account go to [Celo faucets ](https://celo.org/developers/faucets) and send test coin to address to buying the NFT,First, you need to buy a village and next, you will need to buy a farm and mine to pass to the next level. ![Captura de Tela (54)](./assets/celo-hardhat-deploy-and-nft-app-captura-de-tela-54.png) ![Captura de Tela (55)](./assets/celo-hardhat-deploy-and-nft-app-captura-de-tela-55.png)
