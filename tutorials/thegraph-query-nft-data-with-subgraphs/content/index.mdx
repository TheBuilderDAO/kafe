...
![Subgraph Studio](./assets/thegraph-query-nft-data-with-subgraphs-subgraph-studio.png)
...
![OpenSea assets](./assets/thegraph-query-nft-data-with-subgraphs-open-sea-assets.png)
...
![OpenSea Galaxy-Eggs](./assets/thegraph-query-nft-data-with-subgraphs-open-sea-galaxy-eggs.png)

Click on any of the NFTs to view its display page:

![OpenSea Galaxy-Eggs #7836](./assets/thegraph-query-nft-data-with-subgraphs-open-sea-galaxy-eggs-7836.png)
...
![Login to Subgraph Studio](./assets/thegraph-query-nft-data-with-subgraphs-login-to-subgraph-studio.png)
...
![Create your first subgraph](./assets/thegraph-query-nft-data-with-subgraphs-create-your-first-subgraph.png)
...
![GalaxyEggs NFT subgraph](./assets/thegraph-query-nft-data-with-subgraphs-galaxy-eggs-nft-subgraph.png)
...
![GalaxyEggs NFT Subgraph Publish](./assets/thegraph-query-nft-data-with-subgraphs-galaxy-eggs-nft-subgraph-publish.png)
