...
![Metamask](./assets/avalanche-create-a-chat-application-using-solidity-and-react-metamask.png)
...
![remix-preview](./assets/avalanche-create-a-chat-application-using-solidity-and-react-remix-preview.png)
...
![User registration and adding a new friend](./assets/avalanche-create-a-chat-application-using-solidity-and-react-user-registration-and-adding-a-new-friend.png)
...
![Chatting with a friend](./assets/avalanche-create-a-chat-application-using-solidity-and-react-chatting-with-a-friend.png)
...
![Zero balance preview](./assets/avalanche-create-a-chat-application-using-solidity-and-react-zero-balance-preview.png)

- Make sure that you have selected the correct account on metamask if you have more than one account connected to the site.

![Multiple account preview](./assets/avalanche-create-a-chat-application-using-solidity-and-react-multiple-account-preview.png)

## Application crash

![Error!](./assets/avalanche-create-a-chat-application-using-solidity-and-react-error.png)
