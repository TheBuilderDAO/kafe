...
![](./assets/avalanche-connect-datahub-to-metamask-image-1.png)
...
![](./assets/avalanche-connect-datahub-to-metamask-image-2.png)

After setting up all of the parameters, you should see this page, which shows your (empty) balance.

![](./assets/avalanche-connect-datahub-to-metamask-image-3.png)
