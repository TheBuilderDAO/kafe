...
![app demo](./assets/polygon-build-a-quadratic-voting-dapp-app-demo.png)
...
![MetaMask config](./assets/polygon-build-a-quadratic-voting-dapp-meta-mask-config.png)
...
![file structure](./assets/polygon-build-a-quadratic-voting-dapp-file-structure.png)
...
![truffle compile](./assets/polygon-build-a-quadratic-voting-dapp-truffle-compile.png)
...
![truffle migrate](./assets/polygon-build-a-quadratic-voting-dapp-truffle-migrate.png)
...
![truffle test](./assets/polygon-build-a-quadratic-voting-dapp-truffle-test.png)
...
![create item](./assets/polygon-build-a-quadratic-voting-dapp-create-item.png)

When you click on the "Create Item" button you should see MetaMask prompt you to confirm the transaction.

![create item MetaMask](./assets/polygon-build-a-quadratic-voting-dapp-create-item-meta-mask.png)
...
![ranked items with claim button](./assets/polygon-build-a-quadratic-voting-dapp-ranked-items-with-claim-button.png)
...
![ranked items with voting controls](./assets/polygon-build-a-quadratic-voting-dapp-ranked-items-with-voting-controls.png)

Interacting with the "Up"/"Down" buttons will reveal a submit section that allows you to quadratically vote on the item.

![submit vote](./assets/polygon-build-a-quadratic-voting-dapp-submit-vote.png)
...
![submit vote MetaMask](./assets/polygon-build-a-quadratic-voting-dapp-submit-vote-meta-mask.png)
...
![completed app](./assets/polygon-build-a-quadratic-voting-dapp-completed-app.png)
