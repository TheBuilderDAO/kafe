...
![Subgraph Studio](./assets/thegraph-deploy-a-subgraph-for-an-avalanche-smart-contract-subgraph-studio.png)
...
![Datahub Signup](./assets/thegraph-deploy-a-subgraph-for-an-avalanche-smart-contract-datahub-signup.png)
...
![Datahub Avalanche](./assets/thegraph-deploy-a-subgraph-for-an-avalanche-smart-contract-datahub-avalanche.png)
...
![Datahub Avalanche API Key](./assets/thegraph-deploy-a-subgraph-for-an-avalanche-smart-contract-datahub-avalanche-api-key.png)
...
![Metamask FUJI Avalanche](./assets/thegraph-deploy-a-subgraph-for-an-avalanche-smart-contract-metamask-fuji-avalanche.png)
...
![Login to Subgraph Studio](./assets/thegraph-deploy-a-subgraph-for-an-avalanche-smart-contract-login-to-subgraph-studio.png)
...
![Create your first subgraph](./assets/thegraph-deploy-a-subgraph-for-an-avalanche-smart-contract-create-your-first-subgraph.png)

Next, you need to give your subgraph a name. Give the name as **vending**. Once that's done, you will see this screen:

![Subgraph dashboard](./assets/thegraph-deploy-a-subgraph-for-an-avalanche-smart-contract-subgraph-dashboard.png)
