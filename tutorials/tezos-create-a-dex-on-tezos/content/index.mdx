...
![Tez Dex](./assets/tezos-create-a-dex-on-tezos-tez-dex-1.png)

### Swapping Tez into tokens

Click on the Swap button after entering some amount in xtz let's say 1.

![Tez To Token](./assets/tezos-create-a-dex-on-tezos-tez-to-token-2.png)

You can see after exchanging 1 tez we're getting around 97 cat token based on current ratio.
![Transaction](./assets/tezos-create-a-dex-on-tezos-transaction-3.png)
