...
![graph init](./assets/thegraph-the-journey-of-a-subgraph-query-graph-init.png)
...
![Access token](./assets/thegraph-the-journey-of-a-subgraph-query-access-token.png)
...
![graph-auth](./assets/thegraph-the-journey-of-a-subgraph-query-graph-auth.png)
...
![graph-deploy](./assets/thegraph-the-journey-of-a-subgraph-query-graph-deploy.png)
...
![subgraph.yaml](./assets/thegraph-the-journey-of-a-subgraph-query-subgraph-yaml.png)
...
![graph-deploy2](./assets/thegraph-the-journey-of-a-subgraph-query-graph-deploy-2.png)
...
![graph-explorer](./assets/thegraph-the-journey-of-a-subgraph-query-graph-explorer.png)
...
![graph-playground01](./assets/thegraph-the-journey-of-a-subgraph-query-graph-playground-01.png)
...
![graph-playground02](./assets/thegraph-the-journey-of-a-subgraph-query-graph-playground-02.png)
...
![graph-playground03](./assets/thegraph-the-journey-of-a-subgraph-query-graph-playground-03.png)
