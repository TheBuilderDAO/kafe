...
![Payment dApp demo](./assets/polygon-peer-to-peer-payment-on-polygon-part-1-payment-d-app-demo.png)
...
![Datahub Polygon API](./assets/polygon-peer-to-peer-payment-on-polygon-part-1-datahub-polygon-api.png)
...
![Payment gateway UI](./assets/polygon-peer-to-peer-payment-on-polygon-part-1-payment-gateway-ui.png)
