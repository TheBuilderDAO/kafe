...
keywords: [JS/TS, Solidity, React, NodeJS, Solidity, Remix]
date: '2022-03-22T06:03:23.272Z'
---
...
![Metamask](./assets/create-an-amm-on-avalanche_metamask.png)
...
![remix-preview](./assets/create-an-amm-on-avalanche_remix.png)
...
![User registration and adding a new friend](./assets/pyyxvzs.gif)
...
![Chatting with a friend](./assets/lfkjlsk.gif)
...
![Zero balance preview](./assets/create-an-amm-on-avalanche_zero_balance.jpeg)

- Make sure that you have selected the correct account on metamask if you have more than one account connected to the site.

![Multiple account preview](./assets/create-an-amm-on-avalanche_multiple_accounts.jpeg)

## Application crash

![Error!](./assets/chat-dapp-crash.png)
