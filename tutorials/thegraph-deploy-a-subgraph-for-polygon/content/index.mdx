...
![Subgraph Studio](./assets/thegraph-deploy-a-subgraph-for-polygon-subgraph-studio.png)
...
![Datahub Signup](./assets/thegraph-deploy-a-subgraph-for-polygon-datahub-signup.png)
...
![Datahub Polygon API Key](./assets/thegraph-deploy-a-subgraph-for-polygon-datahub-polygon-api-key.png)
...
![Login to Subgraph Studio](./assets/thegraph-deploy-a-subgraph-for-polygon-login-to-subgraph-studio.png)
...
![Create your first subgraph](./assets/thegraph-deploy-a-subgraph-for-polygon-create-your-first-subgraph.png)

Next, you need to give your subgraph a name. Give the name as **FunNFT**. Once that's done, you will see this screen:

![Subgraph dashboard](./assets/thegraph-deploy-a-subgraph-for-polygon-subgraph-dashboard.png)
