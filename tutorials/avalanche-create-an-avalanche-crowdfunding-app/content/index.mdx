...
keywords: [Avalanche, JS/TS, React, Javascript, Solidity]
date: '2022-02-17T23:53:39.662Z'
---
...
![Image displaying contract_architecture](./assets/avalanche-create-an-avalanche-crowdfunding-app-image-displaying-contract-architecture.png)
...
- _REFUNDABLE_:- This type of project returns the amount funded by the contributor when the project fails to achieve the goal amount within the duration.
...
![image of metamask](./assets/avalanche-create-an-avalanche-crowdfunding-app-image-of-metamask.png)
...
![Picture of Remix site](./assets/avalanche-create-an-avalanche-crowdfunding-app-picture-of-remix-site.png)
...
<Hint type="tip">
  Make sure the Solidity compiler version being used in Remix matches the
  version used at the beginning of the smart contract.
</Hint>
...
<Hint type="tip">
  Before deploying the smart contract on testnet, make sure the deployment
  environment in Remix is set to Injected web3.
</Hint>
...
![gif displaying the process of creating a project](./assets/avalanche-create-an-avalanche-crowdfunding-app-gif-displaying-the-process-of-creating-a-project.png)

## Fund Project

![gif displaying the process of funding a project](./assets/avalanche-create-an-avalanche-crowdfunding-app-gif-displaying-the-process-of-funding-a-project.png)

## Claim Fund

![gif displaying the process of claiming refund](./assets/avalanche-create-an-avalanche-crowdfunding-app-gif-displaying-the-process-of-claiming-refund.png)
...
![metamask wallet image with 0 AVAX](./assets/avalanche-create-an-avalanche-crowdfunding-app-metamask-wallet-image-with-0-avax.png)

- Make sure that you have selected the correct account on Metamask if you have more than one account connected to the site.

![metamask wallet with multiple account display](./assets/avalanche-create-an-avalanche-crowdfunding-app-metamask-wallet-with-multiple-account-display.png)
