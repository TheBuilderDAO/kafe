...
![SmartPy](./assets/tezos-mint-nfts-on-tezos-smart-py-1.png)
...
![SmartPy](./assets/tezos-mint-nfts-on-tezos-smart-py-2.png)
...
![SmartPy](./assets/tezos-mint-nfts-on-tezos-smart-py-3.png)
...
![SmartPy](./assets/tezos-mint-nfts-on-tezos-smart-py-4.png)

A new tab will open up.

![SmartPy](./assets/tezos-mint-nfts-on-tezos-smart-py-5.png)
...
![SmartPy](./assets/tezos-mint-nfts-on-tezos-smart-py-6.png)
...
![SmartPy](./assets/tezos-mint-nfts-on-tezos-smart-py-7.png)

Accept the pre-signature information.

![SmartPy](./assets/tezos-mint-nfts-on-tezos-smart-py-8.png)
...
![SmartPy](./assets/tezos-mint-nfts-on-tezos-smart-py-9.png)
...
![IPFS](./assets/tezos-mint-nfts-on-tezos-ipfs-10.png)

Log in and click on upload and choose the image file you want to upload and upload.

![IPFS](./assets/tezos-mint-nfts-on-tezos-ipfs-11.png)

Upload it now.\
The file will get uploaded, and this is your hash.

![IPFS](./assets/tezos-mint-nfts-on-tezos-ipfs-12.png)
...
![better-call.dev](./assets/tezos-mint-nfts-on-tezos-better-call-dev-13.png)
...
![better-call.dev](./assets/tezos-mint-nfts-on-tezos-better-call-dev-14.png)

You can check the fees and also explore the operations which wallet is going to send. Then click confirm.

![better-call.dev](./assets/tezos-mint-nfts-on-tezos-better-call-dev-15.png)

The message will come if it’s successfully sent.

![better-call.dev](./assets/tezos-mint-nfts-on-tezos-better-call-dev-16.png)

After few seconds, refresh and move to the operations tab, you can see the mint operation.

![better-call.dev](./assets/tezos-mint-nfts-on-tezos-better-call-dev-17.png)

You can look at the NFT token metadata in tokens section.

![better-call.dev](./assets/tezos-mint-nfts-on-tezos-better-call-dev-18.png)
