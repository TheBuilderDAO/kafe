...
- Go to your dashboard and click on **Add Subgraph**. Fill in the required details and click on **Create subgraph**.
  ...
  ![Create subgraph](./assets/celo-subgraphs-create-subgraph.png)
...
![Query explorer](./assets/celo-subgraphs-query-explorer.png)
...
![Postman generate code button](./assets/celo-subgraphs-postman-generate-code-button.png)

**Postman generated code results**

![Postman generated code results](./assets/celo-subgraphs-postman-generated-code-results.png)
