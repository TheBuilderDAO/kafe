...
![UNISWAP](./assets/thegraph-uniswap-latest-pair-uniswap-1.png)
...
![UNISWAPEXCHANGE](./assets/thegraph-uniswap-latest-pair-uniswapexchange-2.png)
...
![UNISWAPv3SUBGRAPH](./assets/thegraph-uniswap-latest-pair-uniswa-pv-3-subgraph-3.png)
...
![PLAYGROUND](./assets/thegraph-uniswap-latest-pair-playground-4.png)
...
![PLAYGROUNDCONSTRAINTS](./assets/thegraph-uniswap-latest-pair-playgroundconstraints-5.png)
...
![POSTMANCLEAN](./assets/thegraph-uniswap-latest-pair-postmanclean-6.png)
...
![POSTMANQUERY](./assets/thegraph-uniswap-latest-pair-postmanquery-7.png)
...
![POSTMANJAVASCRIPT](./assets/thegraph-uniswap-latest-pair-postmanjavascript-8.png)
...
![GOOGLESHEETEDITOR](./assets/thegraph-uniswap-latest-pair-googlesheeteditor-9.png)

Replace the empty function with the code we just created.

![Uniswapgs](./assets/thegraph-uniswap-latest-pair-uniswapgs-10.png)
...
![ImportJSONgs](./assets/thegraph-uniswap-latest-pair-import-jso-ngs-11.png)
...
![UNISWAP](./assets/thegraph-uniswap-latest-pair-uniswap-12.png)
