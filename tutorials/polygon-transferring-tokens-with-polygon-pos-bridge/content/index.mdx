...
keywords: [Polygon, JS/TS, Smart contracts, Javascript, Metamask]
date: '2021-09-22T19:13:42.334Z'
---
...
![mumbai](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-mumbai-1.png)
...
- Choose **Gorli Testnet -> Mumbai testnet**
  ...
  ![map image](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-map-image-2.png)
...
![mapped image](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-mapped-image-3.png)
...
![metamask after map](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-metamask-after-map-4.png)
...
2.  **Deposit:** Then a function has to be called on the `RootChainManger` contract which will trigger the `ChildChainManager` contract on the Mumbai testnet. The `ChildChainManager` contract will then call the **deposit** function of the `Child token` contract. **Child** contract is the copy of the **Goerli** token contract in **Mumbai**.
...
- Copy the Mumbai Testnet JSONRPC URL. It is located [here](https://datahub.figment.io/)
...
![MLB Metamask](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-mlb-metamask-5.png)
...
2.  Make sure Ethereum Mainnet is selected in Metamask
    ...
    ![Metamask Ethereum](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-metamask-ethereum-6.png)
...
4.  You will be asked to sign a **Signature Request** to make sure you have access to the wallet. It costs no fees
    ...
    ![pos web ui login](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-pos-web-ui-login-7.png)

5.  I chose `DAI` token from Ethereum

    ![DAI](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-dai-8.png)
...
7.  Then review the transaction details, like gas fees and the smart contract you are sending tokens to - before clicking on **Confirm**
    ...
    ![transfer](./assets/polygon-transferring-tokens-with-polygon-pos-bridge-transfer-9.png)
