...
![UNISWAP](./assets/the-graph-uniswap-latest-pair-uniswap-1.png)
...
![UNISWAPEXCHANGE](./assets/the-graph-uniswap-latest-pair-uniswapexchange-2.png)
...
![UNISWAPv3SUBGRAPH](./assets/the-graph-uniswap-latest-pair-uniswa-pv-3-subgraph-3.png)
...
![PLAYGROUND](./assets/the-graph-uniswap-latest-pair-playground-4.png)
...
![PLAYGROUNDCONSTRAINTS](./assets/the-graph-uniswap-latest-pair-playgroundconstraints-5.png)
...
![POSTMANCLEAN](./assets/the-graph-uniswap-latest-pair-postmanclean-6.png)
...
![POSTMANQUERY](./assets/the-graph-uniswap-latest-pair-postmanquery-7.png)
...
![POSTMANJAVASCRIPT](./assets/the-graph-uniswap-latest-pair-postmanjavascript-8.png)
...
![GOOGLESHEETEDITOR](./assets/the-graph-uniswap-latest-pair-googlesheeteditor-9.png)

Replace the empty function with the code we just created.

![Uniswapgs](./assets/the-graph-uniswap-latest-pair-uniswapgs-10.png)
...
![ImportJSONgs](./assets/the-graph-uniswap-latest-pair-import-jso-ngs-11.png)
...
![UNISWAP](./assets/the-graph-uniswap-latest-pair-uniswap-12.png)
