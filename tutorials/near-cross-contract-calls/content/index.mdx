...
keywords: [Near, JS/TS, Rust, NodeJS, Smart contracts, Javascript]
date: '2021-06-29T19:55:07.855Z'
---
...
![Default Token Contract Test ](./assets/near-cross-contract-calls-default-token-contract-test-1.png)
...
![Jest tests running for Calculator Contract](./assets/near-cross-contract-calls-jest-tests-running-for-calculator-contract-2.png)
...
![Create fresh workspace](./assets/near-cross-contract-calls-create-fresh-workspace-3.png)
...
![Cross contract call Jest test](./assets/near-cross-contract-calls-cross-contract-call-jest-test-4.png)
