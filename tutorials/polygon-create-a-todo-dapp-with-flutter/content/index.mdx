...
![App Demo](./assets/polygon-create-a-todo-dapp-with-flutter-app-demo.png)
...
![Folder Structure](./assets/polygon-create-a-todo-dapp-with-flutter-folder-structure.png)
...
![Truffle Compile](./assets/polygon-create-a-todo-dapp-with-flutter-truffle-compile.png)
...
![Contract Migration](./assets/polygon-create-a-todo-dapp-with-flutter-contract-migration.png)
...
![Ganache Private Key](./assets/polygon-create-a-todo-dapp-with-flutter-ganache-private-key.png)
...
![Todo List](./assets/polygon-create-a-todo-dapp-with-flutter-todo-list.png)
...
![Bottom sheet GIF](./assets/polygon-create-a-todo-dapp-with-flutter-bottom-sheet-gif.png)
