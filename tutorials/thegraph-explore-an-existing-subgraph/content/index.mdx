...
![HOPR Subgraph Playground](./assets/thegraph-explore-an-existing-subgraph-hopr-subgraph-playground-1.png)
...
![Graph React App Pie Chart](./assets/thegraph-explore-an-existing-subgraph-graph-react-app-pie-chart-2.png)
