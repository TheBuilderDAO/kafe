  ...
  return (
    <div className="flex justify-between">
      <SectionContainer>
        ...
        <article className="z-50 flex mt-8 border dark:bg-kafeblack bg-kafewhite border-1 border-kafeblack dark:border-kafewhite">
