...
![tokens balance](./assets/polygon-transfer-nfts-using-the-polygon-pos-bridge-and-sdk-tokens-balance-1.png)
...
![mumbai](./assets/polygon-transfer-nfts-using-the-polygon-pos-bridge-and-sdk-mumbai-2.png)
...
- Choose **Goerli Testnet -> Mumbai testnet**
  ...
  - ERC-1155
    ...
    ![map image](./assets/polygon-transfer-nfts-using-the-polygon-pos-bridge-and-sdk-map-image-3.png)

  - ERC-721

    ![map image](./assets/polygon-transfer-nfts-using-the-polygon-pos-bridge-and-sdk-map-image-4.png)
...
![mapped image](./assets/polygon-transfer-nfts-using-the-polygon-pos-bridge-and-sdk-mapped-image-5.png)
...
![metamask after map](./assets/polygon-transfer-nfts-using-the-polygon-pos-bridge-and-sdk-metamask-after-map-6.png)
...
2.  **Deposit:** Then a function has to be called on the **RootChainManger** contract which will trigger the **ChildChainManager** contract on the Mumbai testnet. The **ChildChainManager** contract will then call the **deposit** function of the **Child token** contract. The **Child** contract is a copy of the **Goerli** testnet token contract in **Mumbai** testnet.
...
- Choose the Polygon service from the [DataHub Services Dashboard](https://datahub.figment.io/)
...
![balances Metamask](./assets/polygon-transfer-nfts-using-the-polygon-pos-bridge-and-sdk-balances-metamask-7.png)
...
![Metamask Goerli](./assets/polygon-transfer-nfts-using-the-polygon-pos-bridge-and-sdk-metamask-goerli-8.png)

3.  Enter the contract address in Goerli and Mumbai, and ID of the token you want to transfer.

4.  Click on **Approve**

![Approve](./assets/polygon-transfer-nfts-using-the-polygon-pos-bridge-and-sdk-approve-9.png)
...
![Deposit](./assets/polygon-transfer-nfts-using-the-polygon-pos-bridge-and-sdk-deposit-10.png)
...
![Transfer Done](./assets/polygon-transfer-nfts-using-the-polygon-pos-bridge-and-sdk-transfer-done-11.png)
